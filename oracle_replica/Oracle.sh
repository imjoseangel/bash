...
main_menu() {
  ...
  1	"Preproduction - Replica:"     "Replicate Oracle to Preproduction Environment:"\
  2	"Develop - Replica:"	       "Replicate Oracle to Developmen Environment:"\
...
case $CHOICE in
1)
./StartOracle.sh Pre-Production 10.100.45.26;
main_menu;;

2)
./StartOracle.sh Develop 10.100.45.27;
main_menu;;
